...
1. Use cursor and WASD arrow keys to look and move around. Press and hold SPACEBAR to apply a constant upward force.
2. A moving vehicle is included. It may be landed on, and the character will move on it relative to the vehicle as if the vehicle was stationary.
